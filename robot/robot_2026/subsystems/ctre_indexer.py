...
# from lib_6107.subsystems.rpm.ctre_rpm_subsystem import ControllerType, CtreRpmConfig, CtreRpmSubsystem
#
# logger = logging.getLogger(__name__)
#
#
# class IntakeConstants(CtreRpmConfig):
...
#
#     max_rpm: revolutions_per_minute = 6000.0
#     limit_current: amperes = 30
#     velocity_feedforward = 0.12         # kV feedforward (output/rps)
#
#
# @autologgable_output
# class RevIntakeIndexer(CtreRpmSubsystem):
#     """
