...
|     <input type="checkbox">      |     Shooter     | Basic subsystem support and proper pykit logging  (support input for RPM for testing)                                                                                                                                                                         |
...
|     <input type="checkbox">      |     Vision      | Make sure all cameras have an apriltags pipeline enabled and set to **APRILTAGS_PIPELINE**                                                                                                                                                                    |
...
|     <input type="checkbox">      | Drive function  | For Drive function, look into the 'square' optional parameter                                                                                                                                                                                                 |
...
|     <input type="checkbox">      |        .        | .                                                                                                                                                                                                                                                             |
|     <input type="checkbox">      |       PTP       | If using PhotonVision, verify or implement [Ping/Pong PhotonVision](https://docs.photonvision.org/en/latest/docs/contributing/design-descriptions/time-sync.html) workaround for accurate timestamps. To enable, it needs to be done in the PhotonVision GUI. 
|     <input type="checkbox">      |        .        | .                                                                                                                                                                                                                                                             |
|     <input type="checkbox">      |        .        | .                                                                                                                                                                                                                                                             |
|     <input type="checkbox">      |     Cleanup     | Once pykit logging works. Drop our 'stats' capability                                                                                                                                                                                                         |
|     <input type="checkbox">      |     Cleanup     | Once pykit logging works, re-evaluate use of python logging.<br/>Will probably keep it, but need to minimize overhead and make messages worthwhile                                                                                                            |
...
| <input type="checkbox" checked>  |     CAN ID      | Get real drivetrain working with initial values and all CAN bus IDs assigned                                                                                                                                                                                  |
| <input type="checkbox" checked>  |    Slew Rate    | Implement and test slew rate limiters for teleop driving                                                                                                                                                                                                      |
| <input type="checkbox" checked>  |   Drivetrain    | Get it actually working and driveable by anyone                                                                                                                                                                                                               |
